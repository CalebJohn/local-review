...
- Read and execute @/workspace/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
**Full step-by-step instructions:** @/workspace/.claude/get-shit-done/workflows/discuss-phase-power.md
