...
- @/workspace/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
...
Display: "✓ Generated /gsd-dev-preferences at /workspace/.claude/commands/gsd/dev-preferences.md"
...
```
Artifacts:
  ✓ /gsd-dev-preferences   /workspace/.claude/commands/gsd/dev-preferences.md
